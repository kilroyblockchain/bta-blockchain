...
packageChaincode(){
    ...
    res=$?
    { set +x; } 2>/dev/null
    verifyResult $res "Failed to package chaincode"
    successln "---------------------------------------------------------------------------"
    successln "Successfully packaged chaincode"
    successln "---------------------------------------------------------------------------"
}
...
approveChaincode(){
    ...
    res=$?
    { set +x; } 2>/dev/null
    verifyResult $res "Failed to approve chaincode"
    successln "---------------------------------------------------------------------------"
    successln "Successfully approved chaincode"
    successln "---------------------------------------------------------------------------"
}
...
checkCommitReadiness(){
    ...
    res=$?
    { set +x; } 2>/dev/null
    verifyResult $res "Failed to check commit of chaincode"
    successln "---------------------------------------------------------------------------"
    successln "Successfully checked commit of chaincode"
    successln "---------------------------------------------------------------------------"
}
...
# _____________________CHAINCODE PROJECT_____________________
...
# # _____________________CHAINCODE MODEL VERSION_____________________
